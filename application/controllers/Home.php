...
/* 		$this->session->set_userdata('city', $city);
	...
	public function menu($id=NULL,$cid=NULL)
	{	
	...
	public function OnlineTakeaway($id=NULL,$cid=NULL)
	{	
		...
		$data['home_info'] = $this->Home_model->get_home_page_setting();
		$data['items'] = $this->cart->contents();
		$this->load->view('menu_takeaway', $data);
	...
	function show_cart(){ 
		...
		foreach ($this->cart->contents() as $items) {
			...
			<tr>
					...
					{
						$output .= "<img src='http://scanjee.com/kot/ui/img/nonveg.png' alt='Food logo'>".' '.$items['name']. "</td>";
					}
					else
					{
						$output .= "<img src='http://scanjee.com/kot/ui/img/veg.png' alt='Food logo'>".' '.$items['name']. "</td>";
					} 
	...
	public function checkout($hotel_id=NULL,$id=NULL,$producttype=NULL)
	{	
