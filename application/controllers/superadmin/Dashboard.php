...
Class Dashboard Extends MY_Controller{
   ...
   // print_r($data['main_role']);exit();
  	$data['main_content'] = 'superadmin/Dashboard_view';
   ...
   // print_r($data['main_role']);exit();
	...
	public function backup_restore()
	{
		...
		$data['main_content'] = 'superadmin/bkmysql';
        $this->load->view('superadmin/includes/template', $data);
	}
	...
	public function misc_data_master()
	{
		...
		//print_r($data['package_info']);exit();
		$data['main_content'] = 'superadmin/misc_data_master';
        $this->load->view('superadmin/includes/template', $data);
	}
	...
	public function professional_engagement()
	{
		...
		//print_r($data['package_info']);exit();
		$data['main_content'] = 'superadmin/professional_engagement';
        $this->load->view('superadmin/includes/template', $data);
	}
	...
	public function receivable_report()
	{
		...
		//print_r($data['package_info']);exit();
		$data['main_content'] = 'superadmin/receivable_report';
        $this->load->view('superadmin/includes/template', $data);
	}
	...
	public function NACH_report()
	{
		...
		//print_r($data['package_info']);exit();
		$data['main_content'] = 'superadmin/NACH_report';
        $this->load->view('superadmin/includes/template', $data);
	}
