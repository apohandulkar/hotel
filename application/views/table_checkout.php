...
<p><a href="#demo" class="btn" data-toggle="collapse" style="border: 1px solid #111;">  + Add New Address</a> </p> 
  ...
  <div id="demo" class="collapse">
  								<form action="<?php echo site_url();?>table/save_address" method="post">
	...
	if($a1c[0]['count'] > 0)
	{
		...
		<input type="radio" name="table_id" required id="table_id" value="<?=$table[0]['name']?>" />
										...
										?>
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="payment_method" type="radio" id="payment" value="Cash On delivery" required class="custom-control-input"> 
													<span class="custom-control-indicator"></span> 
													<span class="custom-control-description">Cash Payment
													</span> </label>
                                            </li>
                                        </ul>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h2>Sign-In</h2>
			...
			<input type="hidden" name="table_id" required id="table_id" value="<?=$table[0]['name']?>" />
			<input type="hidden" name="id" value="<?=$id;?>">
			<input type="hidden" name="hotel_id" value="<?=$hotel_details[0]['id'];?>">
