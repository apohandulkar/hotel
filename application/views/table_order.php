                ...
                <div class="container text-center hero-text font-white">
                    <div class="banner-form">
                       <div class="row">
							  ...
							  <div class="col-md-12">
								<div class="col-md-1">
							<a class="navbar-brand" href="<?php echo site_url();?>table/<?=$id?>"> <img class="img-rounded" src="<?=$home_info[0]['logo']?>" alt=""> </a>

								</div>
							  <form method="post" action="<?php echo site_url();?>table/restaurants">
...
?>								</div>
 ...
 <?php echo date("g:i A", strtotime($hotel_details[0]['opning_hr']));?> To <?php echo date("g:i A", strtotime($hotel_details[0]['closing_hr']));?></p>
            ...
            <div class="breadcrumb">
               <div class="container">
                  <ul>
                     <li><a href="<?php echo site_url();?>table/home" class="active">Home</a></li>
...
<div class="row">
						...
						<form action="<?php echo site_url();?>table/Restaurant_details/<?=$hotel_details[0]['id']?>/<?=$id?>" method="post">
						  <input type="hidden" value="<?php echo set_value('id')?set_value('id'):$id;?>" name="id">
						  <input type="hidden" value="<?php echo set_value('city')?set_value('city'):$hotel_details[0]['city'];?>" name="city">
						  <button style="text-decoration: none;background: #fff;border: none;"><img src="<?php echo site_url();?>theme/images/back.png" class="responsive"></button>
							</form>
						</div>
						...
						<!--<div class="col-md-12" style="padding-left:30px">
							...
							<label class="switch">
						 <input type="checkbox" name="Veg" class="Veg" id='Veg'>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<label class="switch">
						 <input type="checkbox" name="Nonveg" class="Nonveg" id='Nonveg'>
						  <span class="slider round"></span>
						</label>	
						</div>
						</div>
                     ...
                     <div class="sidebar-wrap">
                        <div class="widget widget-cart">
                           <div class="widget-heading">
							 ...
							 <a href="<?php echo site_url();?>Table/checkout/<?=$hotel_details[0]['id']?>/<?=$table[0]['id']?>/<?=$id?>/table" type="button" class="btn theme-btn btn-lg">Proceed</a>
...
<?php
	...
	<div class="col-md-6 a" style="width: 50%;text-align: right;">
  	...
  	<div>
					<a href="<?php echo site_url();?>table/checkout/<?=$hotel_details[0]['id']?>/<?=$id?>/deliver" type="button" class="btn theme-btn" style="width: 100%;border-radius: 15px;">Proceed</a>
					</div>
        </div>
<!--
		<script>
