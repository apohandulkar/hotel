              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Sub Menu</h4>
				                  <a href="<?php echo site_url();?>hotel/hotel/add_sub_menu/" class="btn btn-info pull-right">Add Sub Menu</a>

                                <a href="<?php echo site_url();?>hotel/hotel/import_submenu/" class="dt-button">Import CSV</a>
							 <a href="<?php echo site_url();?>hotel/hotel/sample_submenu/" class="dt-button">Export submenu list</a>
                  ...
                  <div class="table-responsive pt-3">
					...
					$a7=$record17->result_array();
					  ?>
                        <tr >
                          <td> 
						  <a href="<?php echo site_url();?>hotel/hotel/Update_submenu/<?=$r['id']?>">
						  <i class="fa fa-pencil" aria-hidden="true" style="color:green"></i></a>
						  &nbsp; &nbsp;<a href="<?php echo site_url();?>hotel/hotel/Delete_submenu/<?=$r['id']?>">
