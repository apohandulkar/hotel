...
.btn-mokka .badge { 
            ...
            <div class="col-md-12 grid-margin transparent">
			  ...
			  <div class="row">
                  <div class="col-md-2 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>hotel/hotel/Register_hotel" class="btn btn-dblue btn-lg" role="button"><i class="fa fa-building" aria-hidden="true"></i>
 <br />
 <br />
						  Add Hotel</a>                   
                </div>
                <div class="col-md-2 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>hotel/hotel/Hotel" class="btn btn-dblue btn-lg" role="button"><i class="fa fa-building" aria-hidden="true"></i>
 <br /> <br />Edit Hotel</a>
                </div>
                 <div class="col-md-2 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>hotel/hotel/Hotel" class="btn btn-dblue btn-lg" role="button"><i class="fa fa-building" aria-hidden="true"></i>
 <br /> <br />
			  ...
			  <div class="row">
                  <div class="col-md-2 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>hotel/hotel/Main_menu" class="btn btn-dred btn-lg" role="button"><i class="fa fa-building" aria-hidden="true"></i>
 <br />
 <br />
						  Add Main Menu</a>                   
                </div>
                <div class="col-md-2 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>hotel/hotel/Sub_menu" class="btn btn-dred btn-lg" role="button"><i class="fa fa-building" aria-hidden="true"></i>
