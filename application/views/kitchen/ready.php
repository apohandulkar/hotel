...
a:hover {
 ...
 $hotel_id=$this->session->userdata('hotel_id');
	...
	//open
	$sqltakedo = "SELECT count(*) as count FROM order_tbl where IsActive=0 and order_status='Kitchen' and hotel_id='$hotel_id' and `food_status`!='deliver'";
	//echo $sqltaked;
            ...
            <div class="col-md-12 grid-margin transparent">
			  <div class="row">
                           <div class="col-xs-12 col-sm-12 col-md-12">
                            <a href="<?php echo site_url();?>kitchen/Dashboard" class="btn btn-dblue active" role="button"> Open  
						  <span style="background-color:#FF0000;color:#fff;padding:0 2px 0 2px;font-size: 10px;"><?=$dcounto?></span></a>
						  
						  <a href="<?php echo site_url();?>kitchen/kitchen/Ready" class="btn btn-dblue" role="button"> Ready  
					...
					?>
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="headingOne_<?=$id?>">
								<h4 class="panel-title">
									<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne_<?=$id?>" aria-expanded="true" aria-controls="collapseOne_<?=$id?>">
										<?=$ac[0]['count']?> Items | ₹<?=$r['total_amount']?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VIEW CART <i class="fa fa-briefcase" aria-hidden="true"></i>
							...
							<div id="collapseOne_<?=$id?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne_<?=$id?>">
								...
								<a href="<?php echo site_url();?>kitchen/kitchen/order_complete/<?=$r['id']?>"  class="btn btn-warning">Order Complete</a>
								</td>
								</tr>
								<tr>
