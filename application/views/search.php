                    ...
                    <div class="banner-form">
                       <div class="row">
							  ...
							  <div class="col-md-12">
								...
								<div class="col-md-4">
                                <input type="city" class="form-control form-control-lg autocomplete_txt" autocomplete="off" required id="city_0" placeholder="Your Location...." data-type="city" value="<?php echo set_value('city')?set_value('city'):$this->session->userdata('city')?>" name="city" >
								</div>
								<div class="col-md-4">
