                  ...
                  <div class="table-responsive pt-3">
                    <table class="datatable table table-bordered" id="example1">
					  ...
					  ?>
                        <tr >
                          <td> 
						  <a href="<?php echo site_url();?>superadmin/Superadmin/Edit_hotel/<?=$r['id']?>"><i class="fa fa-pencil" aria-hidden="true" style="color:green"></i></a>
						  &nbsp; &nbsp;<a href="<?php echo site_url();?>superadmin/Superadmin/view_hotel/<?=$r['id']?>"><i class="fa fa-eye" aria-hidden="true" style="color:blue"></i></a>
						  </td>
                          <td><?=$r['id']?></td>
                          <td><?=$r['name']?></td>
                          <td><?=$r['address']?></td>
						  ...
						  ?>
						  <td><a href="<?php echo site_url();?>superadmin/Superadmin/Delete_hotel/<?=$r['id']?>" onclick="return confirm('Are you sure to delete this?')"><i class="fa fa-trash" aria-hidden="true" style="color:red"></i></a>
</td>
							</tr>
						  <?php
						}
