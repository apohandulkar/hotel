...
.btn-mokka .badge { 
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin transparent">
              <div class="row">
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Total Hotel Register</p>
					  <?php
					  $sql17="select count(*) as hotel_no from hotel where IsActive=0";
					 $record17 = $this->db->query($sql17);
					$a7=$record17->result_array();
					  ?>
                      <p class="fs-30 mb-2"><?=$a7[0]['hotel_no']?></p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
					...
					<?php
					$date=date("Y-m-d");
					  $sql171="select count(*) as hotel_no from hotel where IsActive=0 and register_date='$date'";
					 $record171 = $this->db->query($sql171);
					$a71=$record171->result_array();
					  ?>
                      <p class="fs-30 mb-2"><?=$a71[0]['hotel_no']?></p>  
					  </div>
                  </div>
                </div>
                ...
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">Yesterday Register</p>
					<?php
					$date=date("Y-m-d");
					  $sql171="select count(*) as hotel_no from hotel where IsActive=0 and register_date='$date'";
					 $record171 = $this->db->query($sql171);
			  ...
			  <h3>Hotel Management</h3><br/>

			  <div class="row">
                  <div class="col-md-3 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>superadmin/Superadmin/Register_hotel" class="btn btn-dblue1 btn-lg" role="button"><i class="fa fa-plus" aria-hidden="true"></i>
 ...
 <br />
                ...
                <div class="col-md-3 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>superadmin/Superadmin/Hotel" class="btn btn-dblue2 btn-lg" role="button"><i class="fa fa-pencil" aria-hidden="true"></i>
 <i class="fa fa-building fa-5x" aria-hidden="true"></i>
 <br /> <br />Edit Existing Hotel</a>
                </div>
                 <div class="col-md-3 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>superadmin/Superadmin/Hotel" class="btn btn-dblue3 btn-lg" role="button"><i class="fa fa-search" aria-hidden="true"></i>
<i class="fa fa-qrcode" aria-hidden="true"></i>

 <br /> <br />
						 Genererate Qr Code</a>
                </div>
                 
              </div>		

			  <h3>Menu Management</h3><br/>

			  <div class="row">
                  <div class="col-md-3 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>superadmin/Superadmin/Main_menu" class="btn btn-dred btn-lg" role="button"><i class="fa fa-plus" aria-hidden="true"></i> <i class="fa fa-building" aria-hidden="true"></i>
 <br />
 <br />
						  Add Main Menu</a>                   
                </div>
                <div class="col-md-3 mb-4 stretch-card transparent">
                          <a href="<?php echo site_url();?>superadmin/Superadmin/Sub_menu" class="btn btn-dred1 btn-lg" role="button"><i class="fa fa-plus" aria-hidden="true"></i> <i class="fa fa-building" aria-hidden="true"></i>
 <br /> <br />Add Sub Menu</a>
                </div>
