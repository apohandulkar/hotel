                    ...
                    <div class="banner-form">
                       <div class="row">
							  ...
							  <div class="col-md-12">
								...
								{
								?>
								<a href="<?php echo site_url();?>home/OnlineTakeaway/<?=$hotel_details[0]['id']?>/<?=$id?>"><i class="fa fa-angle-left" aria-hidden="true"></i> Back to Restaurant</a>
								</div>     
								<div class="col-md-5">
									<center><a class="navbar-brand pull-right" href="<?php echo site_url();?>home/<?=$id?>">
								...
								{
									?>
								<a href="<?php echo site_url();?>home/menu/<?=$hotel_details[0]['id']?>/<?=$id?>"><i class="fa fa-angle-left" aria-hidden="true"></i> Back to Restaurant</a>
									</div>     
								<div class="col-md-5">
									<center><a class="navbar-brand pull-right" href="<?php echo site_url();?>home/<?=$id?>">
									<img class="img-rounded" src="<?=$home_info[0]['logo']?>" alt="">
...
<p><a href="#demo" class="btn" data-toggle="collapse" style="border: 1px solid #111;">  + Add New Address</a> </p> 
  ...
  <div id="demo" class="collapse">
  								<form action="<?php echo site_url();?>home/save_address" method="post">
									   ...
									   <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Address*</label>
                                                <input type="text" name="address" required class="form-control" placeholder="124, Lorem Street.."> </div>
                                        </div>
                                    </div>
								<div class="row">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>City </label>
                                                <input type="text" class="form-control" required name="city" placeholder="Jaipur"> </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Pin Code</label>
                                                <input type="text" class="form-control" required name="pincode" placeholder="302012"> </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
    					...
    					<form action="<?php echo site_url();?>home/save_cart" method="post">
						<input type="hidden" name="id" value="<?=$id?>">
						<input type="hidden" name="hotel_id" value="<?=$hotel_details[0]['id']?>">
						<input type="hidden" name="producttype" value="<?=$type?>">
	...
	{
		?>
		<input type="text" required  placeholder="Please enter address" style="color: red;border: none;font-weight:bold"/>
<?php
	}
	}
		else
                                ...
                                <div class="col-md-5">
								 <div class="sidebar-wrap">
                                    ...
                                    <div class="payment-option">
											...
											?>
											 <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input id="payment" required name="payment_method" type="radio" value="Cash On delivery" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Cash On delivery</span>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="payment_method" type="radio" id="payment" value="Online Payment" required class="custom-control-input"> 
										...
										<input type="hidden" name="radio" value="Deliver">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click','.romove_cart',function(){
			...
			var quantity  = 1;
			$.ajax({
				url : "<?php echo site_url();?>/Home/delete_cart1",
				method : "POST",
		...
		$(document).on('click','.add_qty_cart',function(){
			...
			var quantity  = 1;
			$.ajax({
				url : "<?php echo site_url();?>/Home/add_qty_cart",
				method : "POST",
				data : {row_id : row_id, menu_id: menu_id, product_name: product_name, product_price: product_price, quantity: quantity, hotel_id: hotel_id, productcat: productcat, producttype: producttype},
				success :function(data){
					$('#detail_cart').html(data);
	   ...
	   $.ajax({
		...
		{
			//alert(ii);
			window.location = "<?php echo site_url();?>/home/menu/"+iih+"/"+id;
		}
	   });
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h2>Sign-In</h2>
            ...
            <form class="form-horizontal" action="<?php echo site_url();?>Home/validate_user_checkout" method="post">
...
?>
            <form class="form-horizontal" action="<?php echo site_url();?>home/save_customer_checkout" method="post">
			<input type="hidden" name="controller" value="<?=$controller?>">
			<input type="hidden" name="id" value="<?=$id;?>">
			<input type="hidden" name="hotel_id" value="<?=$hotel_details[0]['id'];?>">
									<input type="hidden" name="type" value="<?=$type?>">
