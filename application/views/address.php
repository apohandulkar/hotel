                  ...
                  <div class="col-md-3">
                     <div class="sidebar clearfix m-b-20">
                        <div class="main-block">
                           ...
                           <ul>
                              <li><a href="<?php echo site_url();?>home/profile/<?=$id?>" class="scroll active">Profile Information</a></li>
                              <li><a href="<?php echo site_url();?>home/address/<?=$id?>" class="scroll">Manage Addresses</a></li>
                              <li><a href="<?php echo site_url();?>home/orderHistory/<?=$id?>" class="scroll">Orders History</a></li>
...
<p><a href="#demo" class="btn" data-toggle="collapse" style="border: 1px solid #111;">  + Add New Address</a> </p> 
  <div id="demo" class="collapse">
  								<form action="<?php echo site_url();?>home/save_address_profile" method="post">
...
foreach($a1 as $r)
{
 ...
 <div class="notice notice-success">
	   ...
	   <br />
	   <a href="#demo1_<?=$r['id']?>" data-toggle="collapse" style="color:green">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	   <a href="<?php echo site_url();?>home/delete_address/<?=$id?>/<?=$r['id']?>" value="">Delete</a>

	     <div id="demo1_<?=$r['id']?>" class="collapse">
  								<form action="<?php echo site_url();?>home/update_address" method="post">
									<input type="hidden" name="id" value="<?=$id?>">
