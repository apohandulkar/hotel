    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h2>Sign-In</h2>
            ...
            <form class="form-horizontal" action="<?php echo site_url();?>Home/validate_user_of" method="post">
...
?>
            <form class="form-horizontal" action="<?php echo site_url();?>home/save_customer_of" method="post">
			<input type="hidden" name="controller" value="<?=$controller?>">
			<input type="hidden" name="city" value="<?=$this->session->userdata('city');?>">
						<input type="hidden" name="hotel_id" value="<?=$hotel_details[0]['id']?>">
