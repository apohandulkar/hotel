...
<br />			  
 ...
 <span style="background-color:#9033FF;color:#fff;padding:0 2px 0 2px;font-size: 10px;"><?=$dcountowk?></span></a>
						  ...
						  <a href="<?php echo site_url();?>waiter/waiter/open_order" class="btn btn-dblue active" role="button"> Open  
					...
					?>
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne_<?=$id?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne_<?=$id?>">
								...
								<a href="<?php echo site_url();?>waiter/waiter/Order_send_to_kitchen/<?=$r['id']?>"  class="btn btn-warning">Send To Kichen</a>
								</td>
								</tr>
								<tr>
								...
								<tr>
								<td colspan="2" >
								<a href="<?php echo site_url();?>waiter/waiter/Order_ready/<?=$r['id']?>"  style="color:#fff" class="btn btn-success pull-right">Order Ready</a>
