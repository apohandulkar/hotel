...
a:hover {
  ...
  <a href="<?php echo site_url();?>waiter/waiter/cash" class="btn btn-dblue" role="button">Cash 
                          ...
                          <a href="<?php echo site_url();?>waiter/waiter/Deliver" class="btn btn-dblue active" role="button"> Deliver
					...
					?>
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne_<?=$id?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne_<?=$id?>">
								...
								<a href="<?php echo site_url();?>waiter/waiter/Order_Accept/<?=$r['id']?>/Deliver"  class="btn btn-success">Accept</a>
								<a href="<?php echo site_url();?>waiter/waiter/Order_Decline/<?=$r['id']?>/Deliver"  class="btn btn-danger">Decline</a>
								</td>
								</tr>
								<tr>
