...
a:hover {
  ...
  <a href="<?php echo site_url();?>waiter/waiter/cash" class="btn btn-dblue active" role="button">Cash 
	...
	if($addtress_id!='')
	{
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne_<?=$id?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne_<?=$id?>">
								...
								<a href="<?php echo site_url();?>waiter/waiter/payment_recived/<?=$r['id']?>/Takeaway"  class="btn btn-success">Payment Recived</a>
