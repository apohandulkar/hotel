            ...
            <div class="col-12 grid-margin">
              <div class="card">
			   ...
			   <?php $success_message = $this->session->flashdata('success_message');
                            ...
                            <?php }  ?>
							<?php
							//echo $this->session->userdata('waiter_id');
							?>
                  <h4 class="card-title">Update Waiter Details</h4>
                   <form class="form-sample" method="post" action="<?php echo site_url();?>waiter/waiter/update_waiter" enctype="multipart/form-data">
