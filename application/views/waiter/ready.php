...
<br />			  
 ...
 <span style="background-color:#9033FF;color:#fff;padding:0 2px 0 2px;font-size: 10px;"><?=$dcountowk?></span></a>
						  ...
						  <a href="<?php echo site_url();?>waiter/waiter/Ready" class="btn btn-dblue active" role="button"> Ready  
					...
					?>
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne_<?=$id?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne_<?=$id?>">
								...
								<a href="<?php echo site_url();?>waiter/waiter/order_complete/<?=$r['id']?>"  class="btn btn-warning">Order Complete</a>
								</td>
								</tr>
								<tr>
