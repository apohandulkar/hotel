   ...
   <!--  <div class="container">
    ...
    <div class="container " style="margin-top:30px;"> 
       <div class="col-md-4 col-md-offset-4" style="">
        <h1 class="text-center" style="font-family:Times New Roman, Times, serif;color:#ffffff;text-shadow: 1px 1px #FF0000;">Login</h1>
                ...
                <?php if($this->session->flashdata('failure_message')!=''){?>
                    <div class="alert alert-warning">
                                ...
                                <strong>Warning!</strong> <?php echo $this->session->flashdata('failure_message')?>
                    </div>
                <?php  }?>
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body" style="background-color:#A9D0F5">
                        <form role="form"  method="post" action="<?php echo site_url();?>agent/ForgotPassword/create">
                            <fieldset>
                                <div class="form-group">
                                    <p>
                                        Enter your email address and your password reset link will be email to you.
                                    </p> 
                                </div>
                                <div class="form-group">
