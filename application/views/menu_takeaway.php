                     ...
                     <div class="sidebar-wrap">
                        <div class="widget widget-cart">
                           <div class="widget-heading">
							 ...
							 <a href="<?php echo site_url();?>home/checkout/<?=$hotel_details[0]['id']?>/<?=$id?>/takeaway" type="button" class="btn theme-btn btn-lg">Proceed</a>
...
<?php
	...
	<div class="col-md-6 a" style="width: 50%;text-align: right;">
  	...
  	<div>
					<a href="<?php echo site_url();?>home/checkout/<?=$hotel_details[0]['id']?>/<?=$id?>/takeaway" type="button" class="btn theme-btn" style="width: 100%;border-radius: 15px;">Proceed</a>
					</div>
        </div>
<!--
		<script>
