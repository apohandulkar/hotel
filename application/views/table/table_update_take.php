...
<div class="row">
						...
						<form action="<?php echo site_url();?>home/Restaurant_details/<?=$hotel_details[0]['id']?>/<?=$id?>" method="post">
                     ...
                     <div class="sidebar-wrap">
                        <div class="widget widget-cart">
                           <div class="widget-heading">
							 ...
							 <a href="<?php echo site_url();?>Update/checkout/<?=$hotel_details[0]['id']?>/<?=$table[0]['id']?>/<?=$id?>/<?=$order?>/table" type="button" class="btn theme-btn btn-lg">Proceed</a>
							 <a href="<?php echo site_url();?>Home/order/<?=$id?>" type="button" class="btn theme-btn btn-lg">Back To Orders</a>
...
<?php
	...
	<div class="col-md-6 a" style="width: 50%;text-align: right;">
  	...
  	<div>
					<a href="<?php echo site_url();?>table/checkout/<?=$hotel_details[0]['id']?>/<?=$table[0]['id']?>/<?=$id?>/<?=$order?>/table" type="button" class="btn theme-btn" style="width: 100%;border-radius: 15px;">Proceed</a>
					</div>
        </div>
<!--
		<script>
